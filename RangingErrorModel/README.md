# Ranging Error Model
This folder holds a Python script for building TensorFlow-based ranging error model used in evaluation scripts.

Please read the top main README file for installation instructions.
