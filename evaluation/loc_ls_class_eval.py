...
if __name__ == '__main__':
	...
	file1 = '../data/evaluation/dataset1/tag_room0.csv'
	file2 = '../data/evaluation/dataset1/tag_room1.csv'
	file3 = '../data/evaluation/dataset2/tag_room0.csv'
	...
	# get node position
	tag_pos1 = [input_data1[0][1], input_data1[0][2]]
	print(tag_pos1)
	tag_pos2 = [input_data2[0][1], input_data2[0][2]]
	print(tag_pos2)
	tag_pos3 = [input_data3[0][1], input_data3[0][2]]
	print(tag_pos3)

	numit = 3333

	classifier = cls.CNNClassifier()
	...
	for a in range(3, 11):
		...
		temp_vect1 = loc.localization_ls_classification(input_data1, tag_pos1, a, classifier, numit)
		temp_vect2 = loc.localization_ls_classification(input_data2, tag_pos2, a, classifier, numit)
		temp_vect3 = loc.localization_ls_classification(input_data3, tag_pos3, a, classifier, numit)
