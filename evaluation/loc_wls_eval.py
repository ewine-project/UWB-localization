...
if __name__ == '__main__':
	...
	for a in range(3, 11):
		...
		temp_vect1 = loc.localization_wls(input_data1, tag_pos1, a, regressor, numit)
		temp_vect2 = loc.localization_wls(input_data2, tag_pos2, a, regressor, numit)
		temp_vect3 = loc.localization_wls(input_data3, tag_pos3, a, regressor, numit)
